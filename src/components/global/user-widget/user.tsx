   ...
   return (
      ...
      >
         <Link
            ...
            className="flex gap-x-2 px-2 py-2 items-center hover:bg-themeGray rounded-md"
            tabIndex={-1}
         >
            <Settings /> Settings
         </Link>
         <Button
            onClick={onLogout}
            variant="ghost"
            className="flex gap-x-3 px-2 py-2 justify-start w-full hover:bg-themeGray rounded-md"
            tabIndex={-1}
         >
            <Logout />
            Logout
