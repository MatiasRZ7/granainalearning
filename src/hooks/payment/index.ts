...
// Custom hook to initialize Stripe Elements
export const useStripeElements = () => {
   // Function to load Stripe with the publishable key from environment variables
   const StripePromise = async () =>
      await loadStripe(process.env.NEXT_PUBLIC_STRIPE_PUBLISH_KEY as string)

   // Return the StripePromise function
...
// Custom hook to create a new group subscription
// It uses the useMutation hook from react-query to create a new group subscription
