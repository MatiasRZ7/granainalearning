...
export const useChannelInfo = () => {
   ...
   // mutation function to update channel info
   ...
   // function that ends channel edit
      ...
      if (inputRef.current && channelRef.current && triggerRef.current) {
         if (
            ...
            if (icon) {
               ...
               // if no icon is selected, end edit
               setEdit(false)
            }
         }
      }
   ...
   // useEffect that listens for click event to end channel edit
   useEffect(() => {
      document.addEventListener("click", onEndChannelEdit, false)
      return () => {
         document.removeEventListener("click", onEndChannelEdit, false)
      }
      // icon in [] is the dependency that triggers the useEffect
   }, [icon])
